randfill:   jsr evaluate6          ;$200 for indirect
            ldx #$02         ;addressing
            stx $02
...
onlyinc01:  inc $01
            ...
            sta $03
            rts
evaluate1:  ldx #$01         ;evaluate total
            ldy #$21         ;for current cell
            cmp #$03         ;3 = alive
            beq storex
            ldx #$00
            ...
            lda ($03),Y
            and #$01
evaluate2:   ldx #$01         ;evaluate total
            ldy #$21         ;for current cell
            cmp #$03         ;3 = alive
            beq storex
            ldx #$00
            ...
            lda ($03),Y
            and #$01
evaluate3:   ldx #$01         ;evaluate total
            ldy #$21         ;for current cell
            cmp #$03         ;3 = alive
            beq storex
            ldx #$00
            ...
            lda ($03),Y
            and #$01
evaluate4:   ldx #$01         ;evaluate total
            ldy #$21         ;for current cell
            cmp #$03         ;3 = alive
            beq storex
            ldx #$00
            ...
            lda ($03),Y
            and #$01
evaluate5:   ldx #$01         ;evaluate total
            ldy #$21         ;for current cell
            cmp #$03         ;3 = alive
            beq storex
            ldx #$00
            ...
            lda ($03),Y
            and #$01
evaluate6:   ldx #$01         ;evaluate total
            ldy #$21         ;for current cell
            cmp #$03         ;3 = alive
            beq storex
            ldx #$00
